              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="<?php echo $profile_pic; ?>" class="img-circle" alt="User Image" />
                    <p>
                      <?php echo $full_name; ?> - <?php echo $occ; ?>
                      <small>Member since <?php echo $joined	; ?></small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="?do=myprofile" class="btn btn-default btn-flat">Profile</a>
                    </div>
                    <div class="pull-right">
                      <a href="include/do_signout.php" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
