<aside class="left-side">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="./"><i class="fa fa-home"></i> Club Home</a></li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="?do=setclubinfo"><i class="fa fa-angle-double-right"></i> Club Info</a></li>
                <li><a href="?do=setdeposits"><i class="fa fa-angle-double-right"></i> Deposits</a></li>
                <li><a href="?do=setpenalties"><i class="fa fa-angle-double-right"></i> Penalties</a></li>
              </ul>
            </li>
            <li><a href="?do=new_expense"><i class="fa fa-money"></i> Expenses</a></li>
            <li><a href="?do=investments"><i class="fa fa-money"></i> Investments</a></li>
